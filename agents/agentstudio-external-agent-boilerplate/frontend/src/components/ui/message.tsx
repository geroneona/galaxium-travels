...
const Message = ({ children, className, ...props }: MessageProps): React.JSX.Element => (
...
const MessageActions = ({ children, className, ...props }: MessageActionsProps): React.JSX.Element => (
